...
This directory contains full-stack End-to-End (E2E) tests for Ouroboros. These tests run against a real Docker backend stack and validate complete user workflows from frontend to database.
